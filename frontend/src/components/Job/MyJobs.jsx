...
const MyJobs = () => {
  ...
  useEffect(()=>{
    const fetchMyJobs = async ()=>{
      try {
        const {data} = await axios.get("https://weak-moth-belt.cyclic.app/api/v1/job/getmyjobs",{withCredentials: true})
...
//Update Job 
  const handleUpdateJob = async(jobId)=>{
    ...
    await axios.put(`https://weak-moth-belt.cyclic.app/api/v1/job/updatejob/${jobId}`, updateJob,{
  ...
  const handleDeleteJob = async(jobId)=>{
    await axios.delete(`https://weak-moth-belt.cyclic.app/api/v1/job/deletejob/${jobId}`,{withCredentials: true})
    .then((res)=>{
      toast.success(res.data.message);
